 ...
 */
	...
	// Set session data
	function mailchimp_set_session( $name, $value, $sanitize = null ) {
	...
	// Get session data
	function mailchimp_get_session( $name, $unset = false ) {
	...
	// Unset session data
	function mailchimp_unset_session( $name ) {
		$wp_session = WP_Session::get_instance();
		unset( $wp_session[$name] );
	}
	...
	function mailchimp_get_site_domain() {
	...
	function mailchimp_prepare_url( $url ) {
	...
	function mailchimp_clean_url( $variable, $url ) {
