...
// Define constants
define( 'GMT_MAILCHIMP_VERSION', '2.4.0' );
 ...
 */
function gmt_mailchimp_set_submit_string() {

	if ( empty( get_site_option( 'gmt_mailchimp_submit_hash' ) ) ) {
		update_site_option( 'gmt_mailchimp_submit_hash', wp_generate_password( 24, false ) );
	}
